    ...
    return (
        <>
            <Link
                ...
                className="flex gap-1 flex-col lg:flex-row cursor-pointer w-full items-center justify-center lg:justify-start lg:px-6 relative">
                {getSvg(title, active)}

                <p
                    className={`${active === title ? 'text-white' : 'text-darker-600'} text-md hidden lg:block capitalize`}>
                    {title}
                </p>
            ...
            {show && title == 'wallet' && (
                <div className='flex flex-col items-center gap-1 lg:px-8 justify-end '>
